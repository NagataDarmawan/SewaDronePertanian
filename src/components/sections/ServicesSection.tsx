          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {SERVICES_DATA.services.map((item, index) => (
              <ScrollReveal key={item.id} delay={100 + index * 75}>
                <div className="relative h-full p-6 sm:p-8 flex flex-col justify-between rounded-3xl bg-black/35 backdrop-blur-xl border border-white/20 shadow-2xl hover:bg-black/50 hover:border-[var(--green-bright)]/50 hover:-translate-y-1.5 transition-all duration-500 group">
